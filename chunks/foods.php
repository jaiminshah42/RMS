...
<section class="fcategories">
	...
	<div class="container">
		...
		<div class="section white center">
			<h3 class="header">Product Area!</h3>
		</div>
			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <span class="card-title activator grey-text text-darken-4"><a class="black-text" href=""><?php echo $arr_all[$i+$j-2]['fname']; ?></a><i class="material-icons right">read_more</i></span>
				      <div class="card-content">
			          <p>Click on Order Now to order</p>
			        </div>
